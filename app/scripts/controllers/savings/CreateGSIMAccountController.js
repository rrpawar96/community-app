        ...
        CreateGSIMAccountController: function (scope, resourceFactory, location, routeParams, dateFilter, WizardHandler) {
            ...
            scope.changeProduct = function () {
                ...
                resourceFactory.savingsTemplateResource.get(scope.inparams, function (data) {
                    ...
                    //scope.formData1.annualFeeAmount = data.annualFeeAmount;
            ...
            // to uniquely represent and link child applications of GSIM application
            ...
            scope.submit = function () {
                ...
                /*    if (scope.clientId) this.formData1.clientId = scope.clientId;
                 if (scope.groupId) this.formData1.groupId = scope.groupId;
                 if (scope.centerId) this.formData1.centerId = scope.centerId;*/
