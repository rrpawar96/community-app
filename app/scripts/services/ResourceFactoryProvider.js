            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                   ...
                   provisioningcriteria: defineResource(apiVer + "/provisioningcriteria/:criteriaId",{criteriaId:'@criteriaId'},{
                    ...
                    saveCreditReport: defineResource(apiVer + "/creditBureauIntegration/saveCreditReport", {apiRequestBodyAsJson:'@apiRequestBodyAsJson', creditBureauId : '@creditBureauId',  creditReportNumber : '@creditReportNumber'}, {
                        post: {method: 'POST'}
                    }),
